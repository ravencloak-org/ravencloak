...
class GroupService(
    ...
    suspend fun createGroup(realmName: String, request: CreateGroupRequest): GroupResponse {
    ...
    suspend fun createSubgroup(realmName: String, parentGroupId: String, request: CreateGroupRequest): GroupResponse {
        val realm = realmRepository.findByRealmName(realmName).awaitSingleOrNull()
            ?: throw ResponseStatusException(HttpStatus.NOT_FOUND, "Realm '$realmName' not found")
    ...
    suspend fun updateGroup(realmName: String, groupId: String, request: UpdateGroupRequest): GroupResponse {
        realmRepository.findByRealmName(realmName).awaitSingleOrNull()
            ?: throw ResponseStatusException(HttpStatus.NOT_FOUND, "Realm '$realmName' not found")
