...
function onMouseEnter(e: MouseEvent) {
  ;(e.currentTarget as HTMLElement).setAttribute('data-hover', '')
}
function onMouseLeave(e: MouseEvent) {
  ;(e.currentTarget as HTMLElement).removeAttribute('data-hover')
}
...
function onFocus(e: FocusEvent) {
  ;(e.currentTarget as HTMLElement).setAttribute('data-focus', '')
}
function onBlur(e: FocusEvent) {
  ;(e.currentTarget as HTMLElement).removeAttribute('data-focus')
}
</script>
...
<template>
  <a
    ...
    @blur="onBlur"
  >
    <!-- TouchTarget: expand hit area to 44x44px on touch devices -->
    <span
  ...
  >
    ...
    <svg
      v-if="loading"
      class="animate-spin -ml-0.5 size-4 sm:size-3.5"
